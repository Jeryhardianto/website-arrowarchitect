    ...
    <div class="container">
      ...
      <div class="section">
                  ...
                  <div class="col-md-6 col-12 my-3 mt-5">
                      <a href="" data-toggle="modal" data-target=".myModal<?= $id ?>">
                          <div class="project-body">            
                              <img class="w-100 img-project" src="<?= BASEURL?>/assets/upload/<?= $foto ?>" data-target="#carouselExampleIndicators" data-slide-to="0">
        ...
        <!-- end gambar -->
                      ...
                      <!-- modal -->
    <div class="modal fade myModal<?= $id ?>" id="myModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" >
            <div class="modal-content bg-transparent">
                <div class="bg-transparent">
                    <button type="button" class="close" onclick="myF()" data-dismiss="modal" aria-label="Close">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="w-100 img-modal" src="assets/img/foto/A1.jpg" alt="">
            ...
            ?>
                ...
                <div class="row mb-5">
                  <div class="col-md-12 col-12">
                    ...
                    <iframe class="d-block w-100" width="1080" height="600" src="<?= $url ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  </div>
                </div>
                <!-- video end -->
