...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?= BASEURL ?>/assets/backend/images/logo-arr.png" />
    <title><?= $data['title'] ?></title>
    <!-- Custom CSS -->
    <link href="<?= BASEURL ?>/assets/backend/libs/flot/css/float-chart.css" rel="stylesheet" />
    <!-- Custom CSS -->
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.php">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?= BASEURL ?>/assets/backend/images/logo-arr.png" alt="homepage" class="light-logo" width="20px" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                        <!-- dark Logo text -->
                        <img src="<?= BASEURL ?>/assets/backend/images/logo-arr.png" width="80px" alt="homepage" class="light-logo"
                             width="140px" />
                    </span>
                        <!-- Logo icon -->
                        <!-- <b class="logo-icon"> -->
